...

    {
...

        {
...

            {
                ...
                if (!safras.Any())
                {
                    ViewBag.Aviso = "Nenhuma safra cadastrada. Você pode criar agendamentos, mas precisará cadastrar safras primeiro.";
                }
                
                if (!atividades.Any())
                {
                    ViewBag.Aviso = "Nenhuma atividade cadastrada. Você pode criar agendamentos, mas precisará cadastrar atividades primeiro.";
                }
...

        {
...

            {
                ...
                // Definir VagasDisponiveis igual a VagasTotais para novo agendamento

                model.VagasDisponiveis = model.VagasTotais;
